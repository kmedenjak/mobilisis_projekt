                ...
                <div class="obrubObrazac" style="width: 500px; height: 400px">
                    ...
                    <form id="obrazac" class="obrazacForma" name="obrazac" method="post" action="{$smarty.server.PHP_SELF}">
                        ...
                        <br><br>
                            ...
                            <input class="formaInput" type="text" id="nazivRodendana" name="nazivRodendana" value="{$naziv}"/>
                            <br> <br>

                            <label for="opisRodendana">Opis rođendana: </label>
                            <textarea id="opisGrupe" name="opisRodendana" style="width: 100%; height: 150px">{$opis}</textarea>
                            <br> <br>
                            <br>
                    </form>
                </div>
